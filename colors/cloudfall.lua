...
local blue = {'#5a6ce8', 63,  'darkblue'}
local cyan = {'#6396fc', 80,  'cyan'}
local ice  = {'#95c5ff', 111, 'cyan'}
local teal = {'#60afff', 75,  'blue'}

local magenta      = {'#8975c0', 168, 'magenta'}
